...
def A3C_model(action_size, state_size):
    ...
    conv1 = keras.layers.Conv2D(32, 8, 4, activation='relu', kernel_initializer='he_normal')(input)
    conv2 = keras.layers.Conv2D(64, 4, 2, activation='relu', kernel_initializer='he_normal')(conv1)
    conv3 = keras.layers.Conv2D(64, 3, 1, activation='relu', kernel_initializer='he_normal')(conv2)
